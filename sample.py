...
from models.sefmol_sfrl import SeFMol, log_sample_categorical, initialize_diffusion_params
...
def sample_diffusion_ligand(model, data, num_samples, sample_mode, batch_size=16, device='cuda:0',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='configs/sampling.yml', type=str)
    ...
    parser.add_argument('--load_ckpt_path', type=str, default='./ckpt.pt')
    parser.add_argument('--result_path', type=str, default='./results/')
    parser.add_argument('--condition_properties', type=list, default=[1, 1, 1, 50, 3.0, 2.0, 0.5, 2])
    ...
    for data_id in range(args.start_id, args.end_id+1):
        ...
        pred_pos, pred_v, pred_pos_traj, pred_v_traj, pred_v0_traj, pred_vt_traj, time_list = sample_diffusion_ligand(
            model, data, config.sample.num_samples, args.sample_mode,
