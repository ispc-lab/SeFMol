...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_path', default='./eval_results', type=str)
    ...
    parser.add_argument('--docking_mode', default='vina_score', type=str, choices=['qvina', 'vina_score', 'vina_dock', 'none'])
